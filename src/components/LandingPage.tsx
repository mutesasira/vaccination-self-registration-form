...
export const LandingPage = () => {
    ...
    return (
        <div className="px-16  my-2 text-xl justify-center block">
            <h2 className="font-bold block">Welcome to Uganda National COVID-19 Self-Registration Portal</h2>
            <p className="text-base block">
                ...
                <h1 className="text-lg">Please Note:</h1> That after registration, the booking will expire in five(5) days from the time of registration and also the <p className="font-bold">Vaccination time is between the date of registration and
                9am and 2pm</p>
            </p>
            <h1 className="text-lg block">How to register</h1>
            ...
            <h1 className="text-lg block">Already vaccinated?</h1> <a href="https://epivac.health.go.ug/certificates/#/">Get your vaccination certificate now</a> <button type="button" onClick={() => { history.push('/booking') }}
